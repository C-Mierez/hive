    ...
    <section>
      <div className="py-vertical container grid gap-8">
        ...
        <h2 className="text-center text-4xl leading-tight">
          Our community has transformed ideas into success stories, and we're so
          thrilled to have them share their experiences with you. This could not
          be possible without our dear users.
        </h2>
      </div>
...
function Stats(params: StatsParams) {
  return (
    <div className=" py-vertical50 border-t-global sticky top-[3.75rem] w-full bg-background">
